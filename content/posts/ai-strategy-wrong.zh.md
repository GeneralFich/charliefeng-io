...
大多数AI战略写作让真正需要落地执行的人失望。这是核心问题，而几乎没有任何生产此类内容的人似乎注意到这一点。

我在Google从事AI基础设施工作——文档管理系统、知识代理、项目管理工具。我亲眼目睹各组织采用麦肯锡和Gartner编写的AI战略，锁定平台，然后花费接下来的十二个月在绕开他们刚部署的工具上打转。那些在SharePoint上积灰的战略文档，是一个在墨迹未干时就已经翻篇的世界的遗物。

这就是我所说的"从一开始就是错的"：2025年1月，Claude Sonnet和GPT-4o两个模型占据了企业AI查询量的91.5%。到12月，没有任何单一模型的份额超过23%。整个竞争格局在一个日历年内完成了重构。与此同时，78%的员工正在使用他们的雇主未经批准的AI工具——不是因为他们是反叛者，而是因为经批准的工具跟不上时代。

咨询框架在同样的诊断上趋于一致。麦肯锡发现只有6%的组织达到AI高绩效标准。BCG说只有5%的公司是"面向未来构建"的。MIT的NANDA报告直言不讳：95%的企业AI试点项目对P&L没有任何可测量的影响。所有人都认同病人病了。但处方——成熟度模型、准备度评估、分阶段路线图——本身就是疾病的一部分。

## 框架在一个惩罚确定性的系统中开具确定性的处方

翻开过去一年的任何一份主要AI战略文件，你都会找到一个包含五个级别的成熟度模型、一个优先级矩阵、以及建立C级治理的建议。你不会找到的，是对以下事实的诚实认知：它所描述的技术，在战略得到实施时，将已经发生根本性的变化。

GPT-4的输入token成本在2023年3月是每百万token 30美元。到2025年中期，同等能力的成本不到2美元——在大约两年内下降了93%。上下文窗口在同一时期从4000个token扩展到200万个。这些不是渐进式的改进，而是相变。当Epoch AI追踪到推理成本以每年50倍的中位数速度下降时，你的18个月AI路线图是在为一个你执行到第二季度时就已不复存在的世界做规划。

那些早早锁定平台的组织正在接受教训。Klarna在2023年用一个OpenAI聊天机器人取代了700名客服人员，每月处理230万次对话。到2025年初，客户满意度下降了22%，公司开始重新招聘人类员工。麦当劳花了三年时间与IBM合作构建AI点餐系统，然后在系统不断往冰淇淋圣代里加培根之后终止了合作。S&P Global发现，2025年有42%的公司放弃了大部分AI计划——高于前一年的17%。这些不是执行失败，而是战略失败——那些战略假设当前的工具就是正确的工具。
...
已经在这样做的企业正在快速移动：92%的财富500强公司现在使用多模型平台，顶级账户平均运行30种不同的AI模型。a16z企业CIO调查证实了这种姿态转变——创新预算在一年内从LLM支出的25%下降到仅7%，不是因为公司停止了创新，而是因为他们不再把AI视为实验，而是开始把它当作可替换的基础设施。制胜的姿态是架构灵活性，而非工具忠诚度。

## 情境整合才是持久的优势

当你切换模型时，不会贬值的是：你的组织编码和检索其机构知识的能力。
...
有用的回应不是禁止影子AI，也不是在员工已经在绕过的企业工具上加倍投入。而是要研究这片影子。人们在选择什么工具？用于哪些任务？这揭示了你的官方工具在哪里失败？Mollick将这些用户称为"秘密半机器人"——那些通过日常实验弄清楚AI如何融入工作流程的人。他们是你最好的战略家。为他们的洞察构建一条通往决策者的路径，你就创造了没有任何咨询框架能卖给你的东西：一个在工作与战略之间实时运行的反馈循环。
