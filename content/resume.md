...
experience:
  - company: GOOGLE
    role: Technical Program Manager, Data Centers
  ...
  - company: AMAZON.COM
    role: Senior Program Manager, Operations Technology
...
education:
  - school: YALE SCHOOL OF MANAGEMENT
    ...
    details: "Leadership: President, Data Analytics Club. Led a 200-member organization, designing the curriculum and teaching weekly workshops on SQL, Python, and Data Visualization to upskill the student body."
  - school: NEW YORK UNIVERSITY, LEONARD N. STERN SCHOOL OF BUSINESS
    degree: Bachelor of Science, Finance, Computer Science & Mathematics
    details: "Relevant Coursework: Algorithms, Data Structures, Linear Algebra, Game Theory."
leadership:
  - organization: YALE SCHOOL OF MANAGEMENT ALUMNI ASSOCIATION
    role: Co-Chair, Seattle Chapter
    dates: 2023 – 2025
    details: Directed the community engagement strategy for the Pacific Northwest region. Drove a 285% increase in active participation and engaging 1,000+ attendees over two years.
skills:
  - category: Product Strategy
    items: Infrastructure Roadmapping, Build-vs-Buy Analysis, Technical Stakeholder Management, GTM Strategy, User Research, API Definition.
  - category: AI & Compute Infrastructure
    items: Agentic AI Frameworks (LangChain, MCP), GPU/TPU Architecture, Data Center Capacity Planning, Thermal & Power Constraints, Kubernetes.
  - category: Data & Technical Stack
