        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative flex-1">
            <input
              ...
              maxLength={2000}
              className="w-full bg-slate-900 border border-slate-800 text-slate-200 rounded-xl py-3.5 pl-4 pr-48 focus:outline-none focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/20 transition-all placeholder:text-slate-600"
              disabled={isLoading}
            />
            ...
            {input.length > 0 && (
              <>
                ...
                <button
                  ...
                  className="absolute right-14 top-1/2 -translate-y-1/2 p-1.5 text-slate-400 hover:text-slate-200 rounded-full hover:bg-slate-800 transition-colors"
                >
                  <X size={14} />
                </button>
              </>
