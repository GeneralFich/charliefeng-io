      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-2">
            <NavItem view={View.HOME} label="Chat" icon={MessageSquare} currentView={currentView} onNavigate={handleNavClick} />
            <NavItem view={View.ABOUT} label="About" icon={FileText} currentView={currentView} onNavigate={handleNavClick} />
            <NavItem view={View.ESSAYS} label="Essays" icon={BookOpen} currentView={currentView} onNavigate={handleNavClick} />
            <div className="h-6 w-px bg-slate-800 mx-2" />
            <NavItem view={View.CONTACT} label="Contact" icon={Mail} currentView={currentView} onNavigate={handleNavClick} />
          </div>
